var containers = angular.module('containers', ['ui.router'], () => {})

containers.config(($stateProvider, $urlRouterProvider) => {
})

containers.service('containersService', function($http, $rootScope) {
    var api = {}
    var url = {}
