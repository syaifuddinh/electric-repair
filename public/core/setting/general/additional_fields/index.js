additionalFields.controller('additionalFields', function($scope, $http, $rootScope,$state,$stateParams,$timeout,$compile, additionalFieldsService, typeTransactionsService) {
    ...
    $scope.edit = function(id) {
        ...
        additionalFieldsService.api.show(id, function(dt){
            $scope.formData = dt
            $timeout(function(){
                $scope.$broadcast('showTypeTransaction', 0)
            }, 400)
        })
