var shipmentSales = angular.module('shipmentSales', ['ui.router'], () => {})

shipmentSales.config(($stateProvider, $urlRouterProvider) => {
    $stateProvider.state('sales_order.shipment',{url:'/shipment',data:{label:'Shipment'},views:{'@':{templateUrl:'core/sales/shipments/view/index.html',controller:'shipmentSales'}}})
    $stateProvider.state('sales_order.shipment.create',{url:'/create',data:{label:'Create'},views:{'@':{templateUrl:'core/sales/shipments/view/create.html',controller:'shipmentSalesCreate'}}})
    $stateProvider.state('sales_order.shipment.show',{url:'/:id',data:{label:'Detail'},views:{'@':{templateUrl:'core/sales/shipments/view/show.html',controller:'shipmentSalesShow'}}})
})

shipmentSales.service('shipmentSalesService', function($http, $rootScope) {
    var api = {}
    var url = {}
