var stockByWarehouseSales = angular.module('stockByWarehouseSales', ['ui.router'], () => {})

stockByWarehouseSales.config(($stateProvider, $urlRouterProvider) => {
    $stateProvider.state('sales_order.stock_by_warehouse',{url:'/stock_by_warehouse',data:{label:'Sales Order'},views:{'@':{templateUrl:'core/sales/stock_by_warehouse/view/index.html',controller:'stockByWarehouseSales'}}})
})

stockByWarehouseSales.service('stockByWarehouseSalesService', function($http, $rootScope) {
    var api = {}
    var url = {}
