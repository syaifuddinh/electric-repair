var stockByItemSales = angular.module('stockByItemSales', ['ui.router'], () => {})

stockByItemSales.config(($stateProvider, $urlRouterProvider) => {
    $stateProvider.state('sales_order.stock_by_item',{url:'/stock_by_item',data:{label:'Sales Order'},views:{'@':{templateUrl:'core/sales/stock_by_item/view/index.html',controller:'stockByItemSales'}}})
})

stockByItemSales.service('stockByItemSalesService', function($http, $rootScope) {
    var api = {}
    var url = {}
