  ...
  <center><h3>LEMBAR LAMPIRAN INTER ISLAND<br>NO: {{$item->code}}</h3></center>
  <br>
  <br>
    <?php
    ...
    <tr>
      ...
      <th class="text-center border-bottom">No. Kontainer</th>
      <th class="text-center border-bottom">Nopol</th>
      <th class="text-center border-bottom">Tipe Kontainer</th>
    ...
    @foreach($manifests as $key => $manifest)
       <tr>
        ...
        <td class="text-center">{{$manifest->container_no}}</td>
